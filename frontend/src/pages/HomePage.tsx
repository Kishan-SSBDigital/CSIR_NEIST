...
const heroSlides = [
  {
    ...
    title: 'Welcome to CSIR-NEIST',
    subtitle:
      'North East Institute of Science and Technology - Advancing Research for Regional Development',
    image:
  ...
  },
  {
    ...
    title: 'Innovation Through Science',
    subtitle:
      'Pioneering research and development for sustainable growth in Northeast India',
    image:
  ...
  },
  {
    ...
    title: 'Empowering Through Knowledge',
    subtitle:
      'Providing advanced scientific solutions and fostering technological innovation',
    image:
...
//       <Section background="white" className="py-8 md:py-16">
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
//           {quickLinks.map((link, index) => (
//             <Card key={index} hoverable className="shadow-md hover:shadow-xl transition-shadow">
//               <CardContent className="p-6 flex flex-col items-center text-center h-full">
//                 <div className="text-blue-700 mb-3">{link.icon}</div>
//                 <h3 className="text-lg font-bold mb-2">{link.title}</h3>
//                 <p className="text-slate-600 mb-4 flex-grow text-sm">{link.description}</p>
//                 <Link
//                   to={link.link}
//                   className="inline-flex items-center font-medium text-blue-700 hover:text-blue-800 text-sm"
//                 >
//                   View <ChevronRight size={16} className="ml-1" />
//                 </Link>
//               </CardContent>
...
//           <div>
//             <h2 className="text-3xl font-bold text-blue-800 mb-4">About CSIR-NEIST</h2>
//             <p className="text-slate-700 leading-relaxed mb-3 text-base">
//               CSIR-North East Institute of Science and Technology (CSIR-NEIST), formerly known as
//               Regional Research Laboratory, is a constituent establishment of the Council of Scientific
//               and Industrial Research (CSIR).
//             </p>
//             <p className="text-slate-700 leading-relaxed mb-6 text-base">
//               Our mission is to carry out R&D activities for the effective utilization of the vast
//               natural resources of Northeast India and to develop technologies that benefit the
//               region's people and industry.
//             </p>
...
//               src="https://images.pexels.com/photos/2280547/pexels-photo-2280547.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
//               alt="CSIR-NEIST research facility"
//               className="rounded-xl shadow-2xl w-full h-64 md:h-80 lg:h-full object-cover"
//             />
//             <div className="absolute inset-0 bg-gradient-to-tr from-blue-800/30 to-transparent rounded-xl" />
//           </div>
//         </div>
//       </Section>

//       <Section title="Our Services" subtitle="Explore our research and development services">
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
//           {servicesData.slice(0, 4).map((service) => (
//             <ServiceCard key={service.id} service={service} />
//           ))}
...
//           {[
//             { icon: <Users />, value: '300+', label: 'Research Scientists' },
//             { icon: <Award />, value: '1000+', label: 'Publications' },
//             { icon: <BarChart3 />, value: '150+', label: 'Patents Filed' },
//             { icon: <Lightbulb />, value: '50+', label: 'Technologies Transferred' },
//           ].map((item, i) => (
//             <div key={i} className="text-center p-4">
//               <div className="bg-white/30 rounded-full p-5 inline-flex items-center justify-center shadow-md mb-3">
//                 {item.icon}
//               </div>
//               <h3 className="text-3xl font-extrabold mb-2">{item.value}</h3>
//               <p>{item.label}</p>
//             </div>
//           ))}
//         </div>
...
//       <Section title="Latest News & Updates" subtitle="Stay informed about our research activities and achievements">
...
//             <Link to="/contact">
//             <Button variant="secondary" size="lg" className="bg-white text-blue-900 hover:bg-blue-100">
//               <Phone size={18} className="mr-2" />
//               Contact NEIST
//             </Button>
//             </Link>            
    ...
    <main id="skip-to-main">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {quickLinks.map((link, index) => (
            <Card
              key={index}
              hoverable
              className="shadow-md hover:shadow-2xl transition-shadow rounded-xl bg-white border border-slate-100"
            >
              <CardContent className="p-6 flex flex-col items-center text-center h-full">
                <div className="text-blue-700 mb-3">{link.icon}</div>
                <h3 className="text-lg font-bold mb-2 text-slate-800">{link.title}</h3>
                <p className="text-slate-600 mb-4 flex-grow text-sm">{link.description}</p>
                <Link
                  to={link.link}
                  className="inline-flex items-center font-medium text-blue-700 hover:text-blue-900 text-sm"
                >
                  View <ChevronRight size={16} className="ml-1" />
                </Link>
              </CardContent>
      ...
      <Section background="light">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-blue-800 mb-6">About CSIR-NEIST</h2>
      ...
      <Section background="primary" className="text-white py-16">
        <div className="text-center mb-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10">
          {[
            ...
            <div key={i} className="text-center p-4">
              <div className="bg-white/30 rounded-full p-5 inline-flex items-center justify-center shadow-md mb-4">
                {item.icon}
              </div>
              <h3 className="text-3xl font-extrabold mb-2">{item.value}</h3>
